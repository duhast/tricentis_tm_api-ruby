...
module TricentisTmApi
  class AttachmentsApi
    ...
    def v1_projects_project_key_test_runs_attachments_id_put_with_http_info(id, project_key, opts = {})
      ...
      # resource path
      local_var_path = '/v1/projects/{project-key}/test-runs/attachments/{id}'.sub('{' + 'id' + '}', id.to_s).sub('{' + 'project-key' + '}', project_key.to_s)
    ...
    def v1_projects_project_key_test_runs_test_run_key_attachments_post_with_http_info(test_run_key, project_key, opts = {})
      ...
      # resource path
      local_var_path = '/v1/projects/{project-key}/test-runs/{test-run-key}/attachments'.sub('{' + 'test-run-key' + '}', test_run_key.to_s).sub('{' + 'project-key' + '}', project_key.to_s)
    ...
    def v1_projects_project_key_test_runs_test_run_key_steps_step_number_attachments_post_with_http_info(test_run_key, step_number, project_key, opts = {})
      ...
      # resource path
      local_var_path = '/v1/projects/{project-key}/test-runs/{test-run-key}/steps/{step-number}/attachments'.sub('{' + 'test-run-key' + '}', test_run_key.to_s).sub('{' + 'step-number' + '}', step_number.to_s).sub('{' + 'project-key' + '}', project_key.to_s)
