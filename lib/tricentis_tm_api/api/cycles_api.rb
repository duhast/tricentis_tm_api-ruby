...
module TricentisTmApi
  class CyclesApi
    ...
    # @option opts [V1ProjectsProjectKeyCyclesCycleIdPutRequest] :v1_projects_project_key_cycles_cycle_id_put_request cyclesApiData.
    # @return [V1ProjectsProjectKeyCyclesPost200ResponseInner]
    def v1_projects_project_key_cycles_cycle_id_put(cycle_id, project_key, opts = {})
      data, _status_code, _headers = v1_projects_project_key_cycles_cycle_id_put_with_http_info(cycle_id, project_key, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [V1ProjectsProjectKeyCyclesCycleIdPutRequest] :v1_projects_project_key_cycles_cycle_id_put_request cyclesApiData.
    # @return [Array<(V1ProjectsProjectKeyCyclesPost200ResponseInner, Integer, Hash)>] V1ProjectsProjectKeyCyclesPost200ResponseInner data, response status code and response headers
    def v1_projects_project_key_cycles_cycle_id_put_with_http_info(cycle_id, project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CyclesApi.v1_projects_project_key_cycles_cycle_id_put ...'
      end
      # verify the required parameter 'cycle_id' is set
      if @api_client.config.client_side_validation && cycle_id.nil?
        fail ArgumentError, "Missing the required parameter 'cycle_id' when calling CyclesApi.v1_projects_project_key_cycles_cycle_id_put"
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling CyclesApi.v1_projects_project_key_cycles_cycle_id_put"
      end
      # resource path
      local_var_path = '/v1/projects/{project-key}/cycles/{cycleId}'.sub('{' + 'cycleId' + '}', CGI.escape(cycle_id.to_s)).sub('{' + 'project-key' + '}', CGI.escape(project_key.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'v1_projects_project_key_cycles_cycle_id_put_request'])

      # return_type
      return_type = opts[:debug_return_type] || 'V1ProjectsProjectKeyCyclesPost200ResponseInner'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['api_key']

      new_options = opts.merge(
        :operation => :"CyclesApi.v1_projects_project_key_cycles_cycle_id_put",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CyclesApi#v1_projects_project_key_cycles_cycle_id_put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @return [Array<V1ProjectsProjectKeyCyclesPost200ResponseInner>]
    def v1_projects_project_key_cycles_search_get(project_key, opts = {})
      data, _status_code, _headers = v1_projects_project_key_cycles_search_get_with_http_info(project_key, opts)
      data
    end
    ...
    # @option opts [Integer] :limit Numeric value that determines that maximum N results will be returned
    # @return [Array<(Array<V1ProjectsProjectKeyCyclesPost200ResponseInner>, Integer, Hash)>] Array<V1ProjectsProjectKeyCyclesPost200ResponseInner> data, response status code and response headers
    def v1_projects_project_key_cycles_search_get_with_http_info(project_key, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CyclesApi.v1_projects_project_key_cycles_search_get ...'
      end
      # verify the required parameter 'project_key' is set
      if @api_client.config.client_side_validation && project_key.nil?
        fail ArgumentError, "Missing the required parameter 'project_key' when calling CyclesApi.v1_projects_project_key_cycles_search_get"
      end
      # resource path
      local_var_path = '/v1/projects/{project-key}/cycles/search'.sub('{' + 'project-key' + '}', CGI.escape(project_key.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CyclesApi.v1_projects_project_key_cycles_search_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CyclesApi#v1_projects_project_key_cycles_search_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
