...
module TricentisTmApi
  class TestCasesApi
    ...
    def v1_projects_project_key_jobs_job_id_get_with_http_info(job_id, project_key, opts = {})
      ...
      # resource path
      local_var_path = '/v1/projects/{project-key}/jobs/{job-id}'.sub('{' + 'job-id' + '}', job_id.to_s).sub('{' + 'project-key' + '}', project_key.to_s)
    ...
    def v1_projects_project_key_test_cases_get_with_http_info(project_key, opts = {})
      ...
      # resource path
      local_var_path = '/v1/projects/{project-key}/test-cases'.sub('{' + 'project-key' + '}', project_key.to_s)
    ...
    def v1_projects_project_key_test_cases_key_automation_put_with_http_info(key, project_key, opts = {})
      ...
      # resource path
      local_var_path = '/v1/projects/{project-key}/test-cases/{key}/automation'.sub('{' + 'key' + '}', key.to_s).sub('{' + 'project-key' + '}', project_key.to_s)
    ...
    def v1_projects_project_key_test_cases_key_delete_with_http_info(key, project_key, opts = {})
      ...
      # resource path
      local_var_path = '/v1/projects/{project-key}/test-cases/{key}'.sub('{' + 'key' + '}', key.to_s).sub('{' + 'project-key' + '}', project_key.to_s)
