...
module TricentisTmApi
  class V1ProjectsProjectKeyTestCasesGet200ResponseItemsInner
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'test_type' => :'String',
        :'fields' => :'V1ProjectsProjectKeyTestCasesGet200ResponseItemsInnerFields',
        :'custom_fields' => :'Array<V1ProjectsProjectKeyTestCasesGet200ResponseItemsInnerCustomFieldsInner>',
        :'ttm_fields' => :'V1ProjectsProjectKeyTestCasesGet200ResponseItemsInnerTtmFields',
        :'requirements' => :'Array<String>',
        :'folder' => :'String',
        :'folder_id' => :'String',
        :'automation' => :'V1ProjectsProjectKeyTestCasesGet200ResponseItemsInnerAutomation'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TricentisTmApi::V1ProjectsProjectKeyTestCasesGet200ResponseItemsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TricentisTmApi::V1ProjectsProjectKeyTestCasesGet200ResponseItemsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ttm_fields')
        self.ttm_fields = attributes[:'ttm_fields']
      end
    ...
    def hash
      [id, key, project, test_category, test_type, fields, custom_fields, ttm_fields, requirements, folder, folder_id, automation].hash
    end
