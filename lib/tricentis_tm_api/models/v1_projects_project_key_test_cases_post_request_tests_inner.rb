...
module TricentisTmApi
  class V1ProjectsProjectKeyTestCasesPostRequestTestsInner
    ...
    def self.openapi_types
      {
        ...
        :'ttm_fields' => :'V1ProjectsProjectKeyTestCasesPostRequestTestsInnerTtmFields',
        :'automation' => :'V1ProjectsProjectKeyTestCasesPostRequestTestsInnerAutomation',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TricentisTmApi::V1ProjectsProjectKeyTestCasesPostRequestTestsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TricentisTmApi::V1ProjectsProjectKeyTestCasesPostRequestTestsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [test_type, fields, custom_fields, ttm_fields, automation, requirements, folder, folder_id].hash
    end
