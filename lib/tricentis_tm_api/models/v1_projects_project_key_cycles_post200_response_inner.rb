...
module TricentisTmApi
  class V1ProjectsProjectKeyCyclesPost200ResponseInner
    attr_accessor :id
    ...
    def self.openapi_types
      {
        ...
        :'assignee' => :'String',
        :'version' => :'V1ProjectsProjectKeyCyclesPost200ResponseInnerVersion',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TricentisTmApi::V1ProjectsProjectKeyCyclesPost200ResponseInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TricentisTmApi::V1ProjectsProjectKeyCyclesPost200ResponseInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [id, name, parent_id, planned_start_date, planned_end_date, assignee, version, fields].hash
    end
