...
module TricentisTmApi
  class V1ProjectsProjectKeyTestRunsPostRequestTestRunsInner
    ...
    def hash
      [test_case_key, precondition, status, name, description, priority, test_category, test_type, assignee, executed_by, planned_start_date, planned_end_date, automation, components, labels, cycle_name, folder_path, steps, fields].hash
    end
