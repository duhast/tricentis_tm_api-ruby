...
If the Ruby gem is hosted at a git repository: https://github.com/duhast/tricentis_tm_api-ruby, then add the following in the Gemfile:

    gem 'tricentis_tm_api', :git => 'https://github.com/duhast/tricentis_tm_api-ruby.git'
