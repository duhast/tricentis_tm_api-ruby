...
# Unit tests for TricentisTmApi::InlineResponse202
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse202' do
  before do
    # run before each test
    @instance = TricentisTmApi::InlineResponse202.new
  end
  ...
  describe 'test an instance of InlineResponse202' do
    it 'should create an instance of InlineResponse202' do
      expect(@instance).to be_instance_of(TricentisTmApi::InlineResponse202)
    end
  end
